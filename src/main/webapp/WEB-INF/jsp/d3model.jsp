...
<head>
    ...
    <script>
      ...
      function makeLocationTree1(treeData) {
        locationData1 = [
          ...
          { id: "i-1-1-2-1-2", parent: "i-1-1-2-1", text: "V2010 (9-321-J166-CC002)" },
          { id: "i-1-1-2-1-3", parent: "i-1-1-2-1", text: "V2036 (9-321-J166-CC001)" },
          { id: "i-1-1-2-2", parent: "i-1-1-2", text: "4Level" },
          { id: "i-1-1-2-2-1", parent: "i-1-1-2-2", text: "V2003 (9-321-J166-CC022)" },
          { id: "i-1-1-2-2-2", parent: "i-1-1-2-2", text: "V2010 (9-321-J166-CC002)" },
          { id: "i-1-1-2-2-3", parent: "i-1-1-2-2", text: "V2036 (9-321-J166-CC001)" },
  ...
  <script>
    ...
    function OpenDocument() {
      ...
      onClickCloseAllButton();

      if (0 <= checked_ids.length) {
      
        onChangeFiles(checked_ids);
      }
    }
  </script>
